...
export function Logo({ variant = "default", className }: LogoProps) {
  return (
    <div className={cn("relative inline-flex items-center select-none", className)}>
      ...
      <div className="font-logo font-black text-2xl tracking-wider">
        <span className={cn(
        ...
        <span className="text-[#c9943a] relative">
          ...
          <span className="relative inline-block mx-[0.5px]">
            <span 
              className="absolute left-1/2 -translate-x-1/2 -top-[6px] w-0 h-0 border-l-[4px] border-r-[4px] border-b-[6px] border-l-transparent border-r-transparent border-b-[#c9943a]"
            />
            I
          </span>
          CH
